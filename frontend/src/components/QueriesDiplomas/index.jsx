  ...
  return (
    <div className="container certificate-body mb-5">
      <div className="certificate">
        <h3>Contenido del Diploma</h3>
      </div>
      <form id="formConsultationCertificate" onSubmit={handleSubmit}>
        <div className="row g-2">
          <div className="col-md-5">
            <div className="form-floating mb-3">
              <input type="number" className="form-control" id="inputQD" placeholder="Número de documento" />
              <label htmlFor="inputQD">Ingrese numero de documento o NRO</label>
            </div>
          </div>
