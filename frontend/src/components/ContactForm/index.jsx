  ...
  return (
    <div className="bodyContactForm">
      <div className="containerContactForm row g-2">
        <div className="leftContactForm col-md mt-5">
          <div className="leftContactFormInfo">
            <img src={logo} alt="Logo" />
          </div>
          <div className="circleLeftContactForm1"></div>
          <div className="circleLeftContactForm2"></div>
          <div className="circleLeftContactForm3"></div>
          <div className="circleLeftContactForm4"></div>
          <div className="circleLeftContactForm5"></div>
          <div className="circleLeftContactForm6"></div>
        </div>
